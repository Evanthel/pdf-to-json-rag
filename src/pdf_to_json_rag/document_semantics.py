...
QUERY_FAMILY_HINTS = {
    ...
    "public_web_listing": ("indeed.com", "job postings", "jobs on indeed.com", "powered by joomla"),
...
QUERY_PURPOSE_HINTS = {
    ...
    "statistical_reference": ("census of agriculture", "median farm size", "figures taken from"),
    "employment_listing": ("indeed.com", "job postings", "jobs on indeed.com"),
    "institutional_communication": ("university", "memorandum", "letterhead"),
